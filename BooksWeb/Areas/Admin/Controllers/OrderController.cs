    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult GetAll(string status)
        {
            ...
            else
            {
                ...
                orderList = _unitOfWork.OrderHeader.GetAll(u => u.ApplicationUserId == userId, includeProperties: "ApplicationUser");
            ...
            {
                case "pending":
                    orderList = orderList.Where(u=> u.PaymentStatus == SD.PaymentStatusPending);
                    break;
                case "inprocess":
