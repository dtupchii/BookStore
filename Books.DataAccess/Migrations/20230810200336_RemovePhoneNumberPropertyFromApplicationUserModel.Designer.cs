...
namespace Books.DataAccess.Migrations
{
    ...
    [Migration("20230810200336_RemovePhoneNumberPropertyFromApplicationUserModel")]
    partial class RemovePhoneNumberPropertyFromApplicationUserModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Books.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Books.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Books.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Books.Models.OrderDetail", b =>
                {
                    b.HasOne("Books.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("Books.Models.ApplicationUser", b =>
                {
                    b.HasOne("Books.Models.Company", "Company")
                        .WithMany()
